...
if (localStorage.getItem("moble")) {
    ...
    $.ajax({
        ...
        type: "POST",
        data: {
            mob: localStorage.getItem("moble")
        },
...
$("#see2").click(function() {
    var oDiv = $("<div class='xiangqing'>                    <img onclick='offMask(this);' id='off' src='img/page1/off.png' alt=''>                </div>");
    $(".page1").append(oDiv);
    oDiv.fadeIn(1000)
});
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            $.ajax({
                                ...
                                data: JSON.stringify({
                                    "Moblie": $("#phone2").val(),
                                    "RecommendMoblie": RecommendMoblie,
                                    "OpenId": openid,
                                    "RecommendNick": RecommendedNick,
...
$("#hgxq").click(function() {
    var oDiv = $("<div class='ck-box'>                    <img onclick='offMask(this);' id='off' src='img/page1/off.png' alt=''>                    <img class='ckjs' src='img/page5/ckjs.jpg' alt=''>                </div>");
    $(".page4").append(oDiv);
    oDiv.fadeIn(1000)
});
$("#phb").click(function() {
    var oDiv = $("<div class='phb'>                    <img onclick='offMask(this);' id='off' src='img/page1/off.png' alt=''>                    <img class='jxk' src='img/page4/jxkj.png' alt=''>                </div>");
    $(".page4").append(oDiv);
    oDiv.fadeIn(1000);
    $(".phb_box").fadeIn(1000);
    $.ajax({
            ...
            if (timeN == 0) {
                ...
                if (localStorage.getItem("moble")) {
                    $.ajax({
                        ...
                        data: {
                            score: num,
                            "moble": localStorage.getItem("moble")
                        },
                        success: function(data) {}
                    })
                }
                ...
                if (jifen && getQueryString("user")) {
                    $.ajax({
                        ...
                        data: JSON.stringify({
                            "Moblie": "",
                            "Nick": getQueryString("user"),
                            "RecommendedMoblie": $("#phone2").val(),
                            "TriggerTime": resTime
                        }),
                        success: function(result) {
                            console.log(result);
...
function share(url) {
    wx.ready(function() {
        wx.onMenuShareTimeline({
            title: "Levi's要带我去旧金山玩了，你也想去？",
            link: url,
            imgUrl: "http://www.createcdigital.com/createc-new/levis/img/logo.jpg",
            success: function() {
